...
function footnotePopup(showIndex, showCloseBtn) {
    ...
    // Set whether to display index and/or close button. Default is true for
    // both
    ...
    const popupContent =
      popupWrapper.appendChild(document.createElement("div"));
    popupContent.id = "popup-content";

    let popupIndex = null;
    if (showIndex) {
        popupIndex = popupWrapper.insertBefore(document.createElement("div"),
                                               popupContent);
    ...
    // didn't work; maybe need to e.inhibitPropagation() on child <div>
    // document.body.addEventListener("click", handler("close"));
    ...
    if (showCloseBtn) {
        ...
        // some day -- couldn't get this to work
